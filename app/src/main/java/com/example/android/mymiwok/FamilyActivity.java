...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("older brotherve", "taachi", R.drawable.family_older_brother, R.raw.family_older_brother));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //release meadia player rescourses
                releaseMediaPlayer();
                mediaPlayer = MediaPlayer.create(FamilyActivity.this, words.get(i).getmAudioResID());
                mediaPlayer.start();
